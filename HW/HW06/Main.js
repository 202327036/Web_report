...
function Heart() {
    ...
    // 첫 번째 베이지어 커브 (왼쪽 하트 부분)
    ctx.bezierCurveTo(200, 200, 300, 200, 300, 220); 
    // 하트 하단 중앙을 300, 300으로 잡고 200, 200으로 쭉 모서리 곡선을 그려준 후,
    // 300,200으로 올라간 후 최종적으로 300, 220까지 곡선을 그려주어 종료시켜줌
 
    // 두 번째 베이지어 커브 (오른쪽 하트 부분)
    ctx.moveTo(300, 300); // 시작점 재설정
    ctx.bezierCurveTo(400, 200, 300, 200, 300, 220); // 3개의 점
    ctx.stroke();
